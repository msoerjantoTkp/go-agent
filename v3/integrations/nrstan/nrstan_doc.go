...
// (https://godoc.org/github.com/iwanbk/go-agent/v3/integrations/nrnats/#StartPublishSegment)
...
// https://github.com/iwanbk/go-agent/blob/master/v3/integrations/nrstan/examples/main.go
package nrstan
