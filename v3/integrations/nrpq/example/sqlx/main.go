...
//	import (
//		"github.com/jmoiron/sqlx"
//		_ "github.com/iwanbk/go-agent/v3/integrations/nrpq"
//	)
//
//	func main() {
...
// `InstrumentSQLDriver`
// (https://godoc.org/github.com/iwanbk/go-agent#InstrumentSQLDriver) API.
// See
// https://github.com/iwanbk/go-agent/blob/master/v3/integrations/nrmysql/nrmysql.go
// for a full example.
//
